...
class EventFormRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'kategori_id.exists' => 'Kategori event yang dipilih tidak valid atau tidak ditemukan.',
            ...
            // Messages untuk Tikets
            'tikets.required' => 'Event wajib memiliki minimal satu tiket.',
            'tikets.array' => 'Format data tiket tidak valid.',
            'tikets.min' => 'Event wajib memiliki minimal satu tiket.',
            ...
            'tikets.*.stok.integer' => 'Stok tiket harus berupa angka bulat (integer).',
            'tikets.*.stok.min' => 'Stok tiket tidak boleh kurang dari 0.',
            'tikets.*.id.exists' => 'Tiket yang dipilih untuk diupdate tidak ditemukan.',
        ];
    }
}
